...
function Collection() {
  ...
  const toggleSubCategory = (e) => {
    if (subCategory.includes(e.target.value)) {
      setSubCategory((prev) => prev.filter((p) => p !== e.target.value));
    } else {
  ...
  const applyFilter = () => {
    ...
    if (subCategory.length > 0) {
      copy = copy.filter((c) => subCategory.includes(c.subCategory));
    }
  ...
  return (
    <div className="flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t">
      ...
      <div className="min-w-60  ">
        ...
        {/* Category */}
        <div
          className={`border border-gray-300 pl-5 pt-3 mt-6  ${
            showFilter ? "" : "hidden"
          } sm:block`}
        >
      ...
      <div className="flex-1">
        <div className="flex justify-between text-base  sm:text-2xl  mb-4">
          ...
          <select
            ...
            className="border-2 border-gray-300 text-sm pz-2 "
          >
